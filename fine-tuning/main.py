...
def get_cuda_lib_handle():
    ...
    try:
        cuda = ct.CDLL("/usr/local/cuda-11.7/targets/x86_64-linux/lib/stubs/libcuda.so")
    except OSError:
...
def evaluate_cuda_setup():
    ...
    binary_name = "/home/user01/anaconda3/envs/llama-lora/lib/python3.10/site-packages/bitsandbytes/libbitsandbytes_cuda117_nocublaslt.so"
